...
var slider = inputs.slider({
  ...
  debounce: true,
  cb: function cb(val) {
    return console.log('slider: ' + val);
  },
  label: 'number'
});
document.querySelector('#slider').innerHTML = slider.build();
var vslider = inputs.vslider({
  el: '#vslider',
  width: 600,
  max: 200,
  min: -100,
...
},{"./src":5}],5:[function(_dereq_,module,exports){
"use strict";
...
},{"./inputs/Button":6,"./inputs/Duration":7,"./inputs/Input":8,"./inputs/Legend":9,"./inputs/PlusMinus":10,"./inputs/Select":11,"./inputs/Slider":12,"./inputs/Tabs":13,"./inputs/Textarea":14,"./inputs/Vslider":15}],6:[function(_dereq_,module,exports){
"use strict";
...
},{"../uid":17,"htm":1,"vhtml":3}],9:[function(_dereq_,module,exports){
"use strict";
